  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        type: "number",
        description:
          "Target video duration in seconds. Required when inputType is idea. E.g., 60 for 1-minute video.",
      },
      {
        name: "captionStyleId",
        in: "body",
        type: "string",
        description:
          'Caption style: "wrap-1" (default, MrBeast-style), "classic", "karaoke", "box", "minimal", "handwritten", "neon".',
      },
      {
      ...
      },
      {
        ...
        type: "string",
        description:
          'For video mediaType only. "standard" (default): balanced quality and speed. "premium": higher detail, slower generation.',
      },
    ],
    auth: true,
    examples: {
