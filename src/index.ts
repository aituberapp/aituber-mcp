...
import { z } from "zod";
import { GENERATED_ENDPOINTS } from "./endpoints.generated.js";
import type { GeneratedEndpoint } from "./endpoints.generated.js";
...
// Endpoint catalog
//
// The endpoint list is generated from the API's OpenAPI spec (see
// endpoints.generated.ts - regenerated by `pnpm docs:generate` in the main
// repo), merged with hand-curated examples from examples.ts.
// ---------------------------------------------------------------------------

type Endpoint = GeneratedEndpoint & {
  example?: string | Record<string, unknown>;
  examples?: Record<string, Record<string, unknown>>;
};

const ENDPOINTS: Endpoint[] = GENERATED_ENDPOINTS.map((ep) => ({
  ...ep,
...
function formatEndpoint(ep: Endpoint): string {
  ...
  lines.push(
    ep.auth
      ? "**Authentication:** Required (handled automatically by execute_api)"
